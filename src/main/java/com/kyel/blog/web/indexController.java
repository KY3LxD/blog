...
public class indexController {
    ...
    public String index(@PageableDefault(size = 5, sort = {"updateTime"}, direction = Sort.Direction.DESC) Pageable pageable,
        ...
        model.addAttribute("recommendedBlogs", blogService.listRecommendedBlog(5));
        return "index";
    }
    ...
    public String getSearch(@PageableDefault(size = 1, sort = {"updateTime"}, direction = Sort.Direction.DESC) Pageable pageable,
    ...
    public String newBlogs(Model model) {
        model.addAttribute("newBlogs", blogService.listRecommendedBlog(3));
